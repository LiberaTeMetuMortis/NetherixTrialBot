...
export type StringOption = { value: string }
export type NumberOption = { value: number }
export type RequestResponse = { success: true, result: number } | // It is successful
                       { success: false, error: { info: string } }  // It is not
